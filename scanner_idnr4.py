...
def get_top_us_tickers(n=300):
    """Ottiene i primi n ticker dal listino S&P 500 tramite Wikipedia"""
    try:
        ...
        # Fallback di emergenza con alcuni titoli principali
        return ["AAPL", "MSFT", "GOOGL", "AMZN", "NVDA", "META", "TSLA", "BRK-B", "UNH", "JNJ"][:n]
